...
function Sidebar() {
  ...
  return (
    ...
    <div className={`${mobileShow 
      ...
      } px-6 w-[17%] h-[calc(100vh-6.625rem)] overflow-x-hidden scrollbar-thin`}>
      {/* Home */}
            ...
            <div className="mb-5">
              <h1 className="font-bold">{group.groupName}</h1>
                {group.groupItems.map((item) => {
                  <div
                    key={item.id}
                    className="flex items-center space-x-6 hover:bg-gray-300 duration-300 rounded-xl p-1 my-2"
                  >
      ...
      <br />
      <p className="text-xs text-gray-500 mt-3">© 2024 Ayush Jain</p>
    </div>
